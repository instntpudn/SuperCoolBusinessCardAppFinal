...
//                System.exit(1);
    ...
    {
        String cmd = "CREATE TABLE IF NOT EXISTS BIZCARDS (BIZCARDID VARCHAR(35), BIZCARDNAME VARCHAR(50), BIZCARDBIZNAME VARCHAR(50), BIZCARDADDRESS VARCHAR(50),BIZCARDPHONE VARCHAR(20), BIZCARDDESCRIPTION VARCHAR(100), BIZCARDEMAIL VARCHAR(100),BIZCARDWEBSITE VARCHAR(256), BIZCARDIMAGENAME VARCHAR(255), PRIMARY KEY (BIZCARDID));";
